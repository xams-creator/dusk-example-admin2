...
import { useAntdTableAutoScrollY } from '@/business/common/components/table';
...
const App = () => {
    ...
    const scrollY = useAntdTableAutoScrollY(tblRef as any);
    return (
        <Space direction="vertical" style={{ width: '100%' }} className={'test-table'}>
            <Space wrap={true}>
                <Switch
                    checked={bordered}
            ...
            <Table
                ...
                pagination={{
                    ...
                    pageSizeOptions: [100, 200, 1000, 10000, 100000],
                    responsive: true,
                }}
                ref={tblRef}
                rowSelection={
